 ...
 * <p>
 * Each style defines a sequence of frames that are cycled through to create an
 ...
 * Spinner spinner = Spinner.builder().spinnerStyle(SpinnerStyle.LINE).build();
 *
 * // Use a custom frame set
 * Spinner spinner = Spinner.builder().frameSet(SpinnerFrameSet.of("*", "+", "x", "+")).build();
 * }</pre>
 *
 * @see SpinnerFrameSet
 */
